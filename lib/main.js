...
RealTime.prototype.messages = function (cb) {
    schedule.scheduleJob("*/5 * * * * *", () => {
        this.yam.messagesWithOlderThan(cb);
        // this.yam.messages(cb);
    });
}
...
Yammer.prototype.messagesWithOlderThan = function (opts, cb) {
    this.request(this.opts.hostname + '/api/v1/messages.json?newer_than=' + Yammer.lastMessageId, opts, cb);
}
